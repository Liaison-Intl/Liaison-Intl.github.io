...
<h2><a name="resource-custom_field_answer_date">Custom Field Answer (Date)</a></h2>
...
<td><em>string</em></td>
<td>Type of data that the <strong>custom field</strong> stores.<br/> <strong>one of:</strong><code>&quot;date&quot;</code></td>
...
<td><code>&quot;Acceptance letter mailed on&quot;</code></td>
</tr>
<tr>
<td><strong>custom_field_answer:value</strong></td>
<td><em>nullable string</em></td>
<td>The ISO 8601 date stored as an answer to the <strong>custom field</strong>.<br/> <strong>pattern:</strong> <code>^\d{4}-\d{2}-\d{2}$</code></td>
<td><code>&quot;2016-01-31&quot;</code></td>
</tr>
</tbody></table>

<h3><a name="link-GET-custom_field_answer_date-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (Date) Show</a></h3>
...
<h3><a name="link-PUT-custom_field_answer_date-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (Date) Store</a></h3>
...
<td><strong>custom_field_answer:value</strong></td>
<td><em>nullable string</em></td>
<td>The ISO 8601 date to be stored as an answer to the <strong>custom field</strong>.<br/> <strong>pattern:</strong> <code>^\d{4}-\d{2}-\d{2}$</code></td>
<td><code>&quot;2016-01-31&quot;</code></td>
</tr>
</tbody></table>
...
<h3><a name="link-DELETE-custom_field_answer_date-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (Date) Destroy</a></h3>
