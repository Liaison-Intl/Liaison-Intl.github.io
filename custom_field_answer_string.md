...
<h2><a name="resource-custom_field_answer_string">Custom Field Answer (String)</a></h2>
...
<h3><a name="link-GET-custom_field_answer_string-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (String) Show</a></h3>
...
<h3><a name="link-PUT-custom_field_answer_string-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (String) Store</a></h3>
...
<h3><a name="link-DELETE-custom_field_answer_string-/api/v1/user_identities/:user_identity_id/programs/:program_id/applicants_by_cas_id/:applicant_cas_id/custom_field_answers/:custom_field_id">Custom Field Answer (String) Destroy</a></h3>
